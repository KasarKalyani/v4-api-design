...
exports.deleteUpdate = exports.updateUpdate = exports.createUpdate = exports.getAllUpdates = exports.getOneUpdate = void 0;
...
var getAllUpdates = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                products = _a.sent();
                updates = products.reduce(function (allUpdates, products) {
                    return __spreadArray(__spreadArray([], allUpdates, true), products.update, true);
                }, []);
...
var updateUpdate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.default.update.update({
                    where: {
                        id: req.params.id
                    },
                    data: req.body
...
var deleteUpdate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.default.update.delete({
                    where: {
                        id: req.params.id,
                    }
                })];
